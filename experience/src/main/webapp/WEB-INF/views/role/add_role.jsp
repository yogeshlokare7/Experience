				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<form class="form-horizontal" method="POST" action="${contextPath}/role/save">
								<input type="hidden" name="id" value="${role.id}">
									<div class="form-group">
										<label class="control-label col-lg-2">Role Name</label>
										<div class="col-lg-10">
											<input type="text" required="required" placeholder="Enter role name" maxlength="30" minlength="2" class="form-control" name="role" value="${role.role}" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" placeholder="Enter role description" maxlength="30" minlength="2"  name="description" value="${role.description}" >
										</div>
									</div>
